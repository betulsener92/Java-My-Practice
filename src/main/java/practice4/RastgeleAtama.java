...
public class RastgeleAtama {
    //Task:
    // Matematik dersinden 6 farkli konu anlatilacaktir.Ogretmen sinifi üc gruba ayırmıştır ve her bir gruba, icinde konu basliklari yazili
    // olan bir torbayı rastgele atayacak kodu yaziniz
